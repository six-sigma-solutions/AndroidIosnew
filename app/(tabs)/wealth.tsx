...
export default function Wealth() {
  ...
  const sections = [
    ...
    },
    {
      ...
      customTicks: [
        {
          text: "True wealth begins with discipline living with intention, saving with wisdom and investing with vision.",
        },
        {
          text: "It grows not only through income but also through knowledge, relationships and the values we pass on to the next generation.",
        },
      ],
    },
    {
        ...
        >
          ...
          {section.customTicks ? (
            <View style={styles.textBox}>
              {section.customTicks.map((tickItem, i) => (
                <View key={i} style={{ flexDirection: 'row', alignItems: 'flex-start', marginBottom: 8 }}>
                  <Text style={styles.tick}>✓</Text>
                  <Text style={styles.text} numberOfLines={null} ellipsizeMode="tail">{tickItem.text}</Text>
                </View>
              ))}
            </View>
          ) : !!section.text && (
