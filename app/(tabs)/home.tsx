  ...
  <AutoScrollView ref={scrollRef} style={styles.container}>    
      ...
      >
        <View style={styles.bannerInner}>
          <Text style={[styles.bannerTitle, { fontSize: getResponsiveFontSize(isTablet, 28) }]}>DM for Health and Wellness </Text>
          <Text style={[styles.bannerSubtitle, { fontSize: getResponsiveFontSize(isTablet, 18) }]}>The World Premium Healthy and Happy Community.</Text>
          ...
          maskElement={
            <View style={styles.maskContainer}>
              <Image
                ...
                style={[styles.maskImage, { width: '100%', height: getResponsiveImageSize(isTablet, isPhone, 920) }]}
              />
            </View>
          }
        >
      ...
      <View style={styles.cardSection}>
        <View style={styles.videoCardContainer}>
          <Image
            style={[styles.videoBackground, { width: '100%', height: getResponsiveImageSize(isTablet, isPhone, 260) }]}
      ...
      <View style={styles.solutionsGrid}>
        <View style={styles.solutionCard}>
          ...
          <Image
            ...
            style={[styles.solutionCardImage, { width: '100%', height: getResponsiveImageSize(isTablet, isPhone, 480) }]}
          />
        </View>
        <View style={styles.solutionCard}>
          <Text style={styles.solutionCardTitle}>
      ...
      <View style={styles.cardSection}>
        <ImageBackground
          ...
          style={[styles.wealthCard, { width: '100%', height: getResponsiveImageSize(isTablet, isPhone, 580) }]}
      ...
      <View style={styles.teamSection}>
        ...
        <View style={styles.founderCard}>
          <Image
            ...
            style={[styles.founderImage, { width: getResponsiveImageSize(isTablet, isPhone, 170), height: getResponsiveImageSize(isTablet, isPhone, 170) }]}
          />
      ...
      <View style={styles.footer}>
        <View style={styles.footerBannerContainer}>
          <Image
            ...
            style={[styles.footerBannerImage, { width: '100%', height: getResponsiveImageSize(isTablet, isPhone, 100) }]}
          />
          <TouchableOpacity
          ...
          <View style={styles.footerLeftColumn}>
            ...
            >
              <Image
                ...
                style={[styles.footerLogo, { width: getResponsiveImageSize(isTablet, isPhone, 100), height: getResponsiveImageSize(isTablet, isPhone, 60) }]}
              />
            </TouchableOpacity>
