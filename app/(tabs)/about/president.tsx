      ...
      <View style={styles.presidentPageSection}>
        <View style={styles.presidentMessageCard}>
          ...
          <View style={styles.viewMoreLink}>
           <Link href="/about/core-values" asChild>
...
const styles = StyleSheet.create({
  ...
  messageQuote: { 
    ...
    fontStyle: 'italic', 
    textAlign: 'justify',
    backgroundColor: 'rgba(235, 221, 221, 1)',
    padding: 16,
    borderRadius: 8,
    fontWeight: '600',
  ...
  messageParagraph: { fontSize: 17, color: '#fff', lineHeight: 26, marginBottom: 16,fontWeight: '600' ,textAlign:'justify' ,marginHorizontal: -2},
